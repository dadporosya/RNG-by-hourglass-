#Taken from: https://github.com/stevenang/randomness_testsuite/blob/master/Spectral.py
...
#
#     @staticmethod
def DiscreteFourierTransform(binary_data:str, debug=False):
    """
...
# print(DiscreteFourierTransform(input()))